...
from Attacker_3DADV import Attack_GGS_CGC_NGS
from Attacker_3DADV import Attack_Default
...
if __name__ == '__main__':
    ...
    parser.add_argument('--attack_label', default='Untarget', type=str)
    parser.add_argument('--binary_max_steps', type=int, default=10)
    parser.add_argument('--iter_max_steps', default=100, type=int)
    parser.add_argument('--lr', type=float, default=0.15, help='Learning rate')
    parser.add_argument('--step_a', type=float, default=0.15)
    ...
    parser.add_argument('--initial_const', type=float, default=1)
    ...
    parser.add_argument('--dis_loss_type', type=str, default='L2',
                        choices=['CD', 'L2', 'KNN', 'None'], help='Distance loss type')
    parser.add_argument('--dis_loss_weight', type=float, default=1.0)
    parser.add_argument('--is_cd_single_side', action='store_true', default=False)

    # Evaluation config
    parser.add_argument('--curv_loss_knn', type=int, default=16)
    parser.add_argument('--hd_loss_weight', type=float, default=0.0)
    parser.add_argument('--curv_loss_weight', type=float, default=0.0)
    parser.add_argument('--uniform_loss_weight', type=float, default=0.0)
    ...
    parser.add_argument('--is_pro_grad', action='store_true', default=False)
    parser.add_argument('--is_pre_jitter_input', action='store_true', default=False)
