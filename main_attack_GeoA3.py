...
from Attacker_GeoA3 import Attack_GGS_CGC_NGS
from Attacker_GeoA3 import Attack_Default
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_num', type=int, default=10, help='Number of calibration cycles K')
    ...
    # PGD-like / momentum-based attack controls
    ...
    # Loss Config
    parser.add_argument('--cls_loss_type', type=str, default='CE', choices=['Margin', 'CE'],
                        help='Classification loss type')
    parser.add_argument('--confidence', type=float, default=0, help='Confidence for margin-based attack')

    parser.add_argument('--dis_loss_type', type=str, default='CD',
                        choices=['CD', 'L2', 'KNN', 'None'], help='Distance loss type')
    parser.add_argument('--dis_loss_weight', type=float, default=1.0, help='Weight of distance loss')
    parser.add_argument('--is_cd_single_side', action='store_true', default=False, help='Use single-side Chamfer distance')

    parser.add_argument('--hd_loss_weight', type=float, default=0.1, help='Weight of Hausdorff loss')
    parser.add_argument('--curv_loss_weight', type=float, default=1.0, help='Weight of curvature loss')
    ...
    # System & Log
    parser.add_argument('-j', '--num_workers', type=int, default=8, metavar='N', help='Number of data loading workers')
